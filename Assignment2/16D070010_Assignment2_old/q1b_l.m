...
NA = 10^16; %cm^-3
ND = 10^16; %cm^-3
xp = 255*10^-7; %cm xp is length of ptype region 0-xp is ptype
xn = 255*10^-7; %cm xp is length of ntype region xp-xp+xn is ntype
...
%roh
N(1:xp/x) =   -(q*NA/xp).*xgrid(1:xp/x).*deltx^2/epsi;
N((xp/x)+1:((xn+xp)/x)) = -(q*ND/xn).*(xgrid((xp/x)+1:((xn+xp)/x))-xn-xp).*deltx^2/epsi;
