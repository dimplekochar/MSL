...
(define zmeshmax2 z2)
;material 
(sdegeo:create-rectangle (position x1 y1 z1)  (position x2 y2 z2) "Silicon" "region_1" )

;Doping
(sdedr:define-constant-profile "ConstantProfileDefinition_1" "PhosphorusActiveConcentration" 1e16)
